...
.proc decode_play_sync
	...
	.macro play_sample_2_comb_minus3
		lda a:playback_delay_count ;  4  4
		sec                        ;  2  6
		sbc #2                     ;  2  8
		@delay_loop_2:
			sbc #1              ;  2
		...
		lda a:tmp_sample_2         ;  4  1 + 5n
		adc tmp_sample_1           ;  3  4 + 5n
		lsr a                      ;  2  6 + 5n
		sta $4011                  ;  4 10 + 5n
	.endmacro
...
load_slopes:                        ;     15
	lda slopes_bank             ;  3  18
	sta $8001                   ;  4  22

	ldy #$00                    ;  2  24
	lda (ptr_slopes), y         ;  5  29
	sta slope0                  ;  3  32
...
slope_update:                                ;     ..      36
	...
	;                                    ; -1  ..      ..   43
	nop                                  ;  2  ..      ..   45
	play_sample_2_comb                   ; 13               58 + 5n
	inc ptr_slopes + 1                   ;  5  ..      ..    6
	nop                                  ;  2  ..      ..    8
	nop                                  ;  2  ..      ..   10
	nop                                  ;  2  ..      ..   12
	jmp load_slopes                      ;  3  ..      ..   15
...
carry_ptr_bitstream:                         ;     29
	...
	c_bne slope_update_2                 ;  3  43
        ;                                    ; -1  42
	inc idx_superblock                   ;  5  47
	play_sample_2_comb_minus3            ; 10  57 + 5n
	dec mmc3_mutex                       ;  5   4
	jmp load_next_superblock             ;  3   7  load next superblock
